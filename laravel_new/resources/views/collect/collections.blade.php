...
</script><script type="text/javascript" async="" src="{{asset('/styles/js/conversion.js')}}"></script><script src="{{asset('/styles/js/allmobilize.min.js')}}" charset="utf-8" id="allmobilize"></script><style type="text/css"></style>
...
<script src="{{asset('/styles/js/additional-methods.js')}}" type="text/javascript"></script>
<!--[if lte IE 8]>
...
<div id="body">
	<div id="header">
    	<div class="wrapper">
    		<a class="logo" href="h/">
    			<img width="229" height="43" alt="拉勾招聘-专注互联网招聘" src="{{asset('/styles/images/logo.png')}}">
    		</a>
        ...
        <div class="clearfix">
                    ...
                    <dd>
                            ...
                            <ul class="reset my_collections">
                             		...
                             		<a title="携程旅行网" target="_blank" href="h/c/6636.html">
                             			<img alt="携程旅行网" src="{{asset('/styles/images/ff808081441c19bf01441f9a47190b3a.png')}}">
                             		</a>
                             		<div class="co_item">
                             			<h2 title="酒店业务助理">
                             		...
                             		<a title="蘑菇街" target="_blank" href="h/c/108.html">
                             			<img alt="蘑菇街" src="{{asset('/styles/images/ff80808142a8df050142b1674c596676.jpg')}}">
                             		</a>
                             		<div class="co_item">
                             			<h2 title="PHP">
                             		...
                             		<a title="搜狗" target="_blank" href="h/c/1537.html">
                             			<img alt="搜狗" src="{{asset('/styles/images/ff80808142e0968f0142e0d41f1205f2.jpg')}}">
                             		</a>
                             		<div class="co_item">
                             			<h2 title="商家运营">
            ...
            <div class="content_r">
            	<div class="mycenterR" id="myInfo">
                	...
                	<img width="242" height="242" alt="拉勾微信公众号二维码" src="{{asset('/styles/images/qr_delivery.png')}}">
                    <span class="c7">扫描拉勾二维码，微信轻松搜工作</span>
                </div>
            </div>
       	</div>
<script src="{{asset('/styles/js/collections.min.js')}}"></script>
<!--<script>
$(function(){
	$('.Pagination').pager({
	      currPage: 1,
...
<script src="{{asset('/styles/js/popup.min.js')}}" type="text/javascript"></script>
