...
<head>
<script id="allmobilize" charset="utf-8" src="{{asset('/styles/style/js/allmobilize.min.js')}}"></script>
...
<link rel="stylesheet" type="text/css" href="{{asset('/styles/style/css/style.css')}}"/>
<link rel="stylesheet" type="text/css" href="{{asset('/styles/style/css/external.min.css')}}"/>
<link rel="stylesheet" type="text/css" href="{{asset('/styles/style/css/popup.css')}}"/>
<script src="{{asset('/styles/style/js/jquery.1.10.1.min.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="{{asset('/styles/style/js/jquery.lib.min.js')}}"></script>
<script src="{{asset('/styles/style/js/ajaxfileupload.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="{{asset('/styles/style/js/additional-methods.js')}}"></script>
<!--[if lte IE 8]>
	...
	<div id="header">
    	<div class="wrapper">
    		<a href="index.html" class="logo">
    			<img src="{{asset('/styles/style/images/logo.png')}}" width="229" height="43" alt="拉勾招聘-专注互联网招聘" />
    		</a>
...
<script type="text/javascript" src="{{asset('/styles/style/js/search.min.js')}}"></script>
<dl class="hotSearch">
	<dt>热门搜索：</dt>
	...
	<dd><a href="list.html?gx=实习&city=">实习</a></dd>
			...
			<div id="home_banner">
	            <ul class="banner_bg">
	                    ...
	                    <a href="h/subject/s_buyfundation.html?utm_source=DH__lagou&utm_medium=banner&utm_campaign=haomai" target="_blank"><img src="{{asset('/styles/style/images/d05a2cc6e6c94bdd80e074eb05e37ebd.jpg')}}" width="612" height="160" alt="好买基金——来了就给100万" /></a>
	                </li>
	                	                <li  class="banner_bg_2" >
	                    <a href="h/subject/s_worldcup.html?utm_source=DH__lagou&utm_medium=home&utm_campaign=wc" target="_blank"><img src="{{asset('/styles/style/images/c9d8a0756d1442caa328adcf28a38857.jpg')}}" width="612" height="160" alt="世界杯放假看球，老板我也要！" /></a>
	                </li>
	                	                <li  class="banner_bg_3" >
	                    <a href="h/subject/s_xiamen.html?utm_source=DH__lagou&utm_medium=home&utm_campaign=xiamen" target="_blank"><img src="{{asset('/styles/style/images/d03110162390422bb97cebc7fd2ab586.jpg')}}" width="612" height="160" alt="出北京记——第一站厦门" /></a>
	                </li>
	                	            </ul>
	            <div class="banner_control">
	                ...
	                <ul class="thumbs">
	                        ...
	                        <i></i>
	                        <img src="{{asset('/styles/style/images/4469b1b83b1f46c7adec255c4b1e4802.jpg')}}" width="113" height="42" />
	                    </li>
	                    	                    <li  class="thumbs_2" >
	                        <i></i>
	                        <img src="{{asset('/styles/style/images/381b343557774270a508206b3a725f39.jpg')}}" width="113" height="42" />
	                    </li>
	                    	                    <li  class="thumbs_3" >
	                        <i></i>
	                        <img src="{{asset('/styles/style/images/354d445c5fd84f1990b91eb559677eb5.jpg')}}" width="113" height="42" />
	                    </li>
	                    	                </ul>
	            </div>
	        </div><!--/#main_banner-->
        	...
        	<ul id="da-thumbs" class="da-thumbs">
	                    ...
	                    <a href="h/c/1650.html" target="_blank">
	                        <img src="{{asset('/styles/style/images/a254b11ecead45bda166afa8aaa9c8bc.jpg')}}" width="113" height="113" alt="联想" />
	                        <div class="hot_info">
	                        	<h2 title="联想">联想</h2>
	                            <em></em>
	                            <p title="世界因联想更美好">
	                    ...
	                    <a href="h/c/9725.html" target="_blank">
	                        <img src="{{asset('/styles/style/images/c75654bc2ab141df8218983cfe5c89f9.jpg')}}" width="113" height="113" alt="淘米" />
	                        <div class="hot_info">
	                        	<h2 title="淘米">淘米</h2>
	                            <em></em>
	                            <p title="将心注入 追求极致">
	                    ...
	                    <a href="h/c/1914.html" target="_blank">
	                        <img src="{{asset('/styles/style/images/2bba2b71d0b0443eaea1774f7ee17c9f.png')}}" width="113" height="113" alt="优酷土豆" />
	                        <div class="hot_info">
	                    ...
	                    <a href="h/c/6630.html" target="_blank">
	                        <img src="{{asset('/styles/style/images/f4822a445a8b495ebad81fcfad3e40e2.jpg')}}" width="113" height="113" alt="思特沃克" />
	                        <div class="hot_info">
	                    ...
	                    <a href="h/c/2700.html" target="_blank">
	                        <img src="{{asset('/styles/style/images/5caf8f9631114bf990f87bb11360653e.png')}}" width="113" height="113" alt="奇猫" />
	                        <div class="hot_info">
	                        	<h2 title="奇猫">奇猫</h2>
	                            <em></em>
	                    ...
	                    <a href="h/c/1335.html" target="_blank">
	                        <img src="{{asset('/styles/style/images/c0052c69ef4546c3b7d08366d0744974.jpg')}}" width="113" height="113" alt="堆糖网" />
	                        <div class="hot_info">
	                        	<h2 title="堆糖网">堆糖网</h2>
	                            <em></em>
...
<script type="text/javascript" src="{{asset('/styles/style/js/core.min.js')}}"></script>
<script type="text/javascript" src="{{asset('/styles/style/js/popup.min.js')}}"></script>
